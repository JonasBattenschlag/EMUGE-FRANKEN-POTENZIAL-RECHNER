...
1. Kunde erscheint in der Liste
...
1. **QUICKSTART lesen** → 30-Sekunden-Anleitung
1. **Auf Handy installieren** → Home-Screen-Shortcut
1. **Erste Kunden eingeben** → Live ausprobieren
1. **Regelmäßig nutzen** → Bei jedem Kundenkontakt
